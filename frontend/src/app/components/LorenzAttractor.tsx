...
import type { SimulationDetail, LorenzParams } from '../types/simulation';
...
const LorenzAttractor: React.FC<LorenzAttractorProps> = ({ detail, onBackToHistory }) => {
    const params = detail.input_params.params as LorenzParams;
    const results = detail.results;
    const [mode, setMode] = useState<VisualizationMode>('3D');

    const renderVisualization = () => {
        const plotResults = [results];
        const titlePrefix = `Lorenz Attractor #${detail.id}`;
        ...
        <div className="simulation-result">
            <div className="simulation-layout">
                <div className="info-column">
                    <h3>Lorenz Attractor Simulation #{detail.id}</h3>
                    ...
                    <div className="params-display">
                        ...
                        <p>Sigma (σ): {params.sigma}</p>
                        <p>Rho (ρ): {params.rho}</p>
                        <p>Beta (β): {params.beta}</p>
